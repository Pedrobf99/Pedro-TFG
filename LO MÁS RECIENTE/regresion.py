...
def ajuste(t_final,b,bounds,mem):
...
def ajuste_graph(t_final,b,filename):
    ajust="Ajustes/"
    hs=[]
    for j in range(0,8):
        for i in range(0,4):
    ...
    for i in range(0,4):
        ...
        axs[0, 0].plot(t_final[i],b[i],ls='',marker='o', markersize=3,color=colours[i])
    ...
    for i in range(0,4):
        ...
        axs[0, 1].plot(t_final[i+4],b[i+4],ls='', markersize=3,marker='o',color=colours[i])
    ...
    for i in range(0,4):
        ...
        axs[0, 2].plot(t_final[i+8],b[i+8],ls='', markersize=3,marker='o',color=colours[i])
    ...
    for i in range(0,4):
        ...
        axs[0, 3].plot(t_final[i+12],b[i+12], markersize=3,ls='',marker='o',color=colours[i])
    ...
    for i in range(0,4):
        ...
        axs[1, 0].plot(t_final[i+16],b[i+16], markersize=3,ls='',marker='o',color=colours[i])
    ...
    for i in range(0,4):
        ...
        axs[1, 1].plot(t_final[i+20],b[i+20],ls='', markersize=3,marker='o',color=colours[i])
    ...
    for i in range(0,4):
        ...
        axs[1, 2].plot(t_final[i+24],b[i+24],ls='', markersize=3,marker='o',color=colours[i])
    ...
    for i in range(0,4):
        ...
        axs[1, 3].plot(t_final[i+28],b[i+28],ls='', markersize=3,marker='o',color=colours[i])
    ...
    for ax in axs.flat:
        ax.set(xlabel='Tiempo (ms)', ylabel='Lectura analógica')
    
    # Hide x labels and tick labels for top plots and y ticks for right plots.
    for ax in axs.flat:
        ax.label_outer()
    
    fig.savefig(ajust+filename[:-4]+'_ajustes.png')

    return 'Nombre de la gráfica: '+filename[:-4]+'_ajustes.png'



def regs(caract,valores):
    vari=[]
    for j in range(0,3):
        ass=[]
        bs=[]
