...
folder="Datos/"
graf="graficas/"
filename="Datos_casita_elvis_NCAP_sinluz.csv"

#file = open(folder+filename, "r") #añadimos informacion al archivo
...
plt.savefig(graf+filename[:-4]+".png")
plt.savefig(graf+filename[:-4]+".eps",format='eps')
